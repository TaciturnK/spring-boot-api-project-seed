...
## 2018年3月8日  By  Taowd  
## 项目优化
- 处理Restful模板生成Controller时个别代码生成错误的问题
- 使用restclient工具对生成的接口进行测试，本次对生成的代码进行了全部测试
- 项目集成Swagger2工具，可以方便查看接口以及测试 http://127.0.0.1:8989/swagger-ui.html

![](https://i.imgur.com/JpliTGb.png)

## 注意：使用代码使用时，需要修改两处数据库配置
- application-dev.properties文件中配置数据库  项目正式使用的数据库
- CodeGenerator.java  中配置数据库，用于生成代码````